...
import { StyleSheet, Text, View, TouchableOpacity, TextInput, Image, ActivityIndicator, FlatList, Dimensions, ScrollView, Animated, Easing } from "react-native"
...
export default function HomeScreen() {
  ...
  async function startSessionWith(content: string) {
  ...
  const showMic = text.trim().length === 0 && !sending && !transcribing
      ...
      <SafeAreaView style={styles.safe}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.inputCard}>
            ...
            />
            {showMic ? (
              <TouchableOpacity onPressIn={onMicDown} onPressOut={onMicUp} style={styles.sendBtn} disabled={transcribing} activeOpacity={0.9}>
